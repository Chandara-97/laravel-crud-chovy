    ...
    <section class="container">
        <form action={{route('bachelor.update',$bachelors->id)}} method='post' enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name = "name" class="form-control" id="pname"  placeholder="Product name" value="{{$users->name}}">
            </div>
            <div class="form-group">
                <label for="pname">Name</label>
                <input type="text" name = "email" class="form-control" id="pname"  placeholder="Product name" value="{{$uers->name}}">
            </div>
